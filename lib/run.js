...
exports.run = exports.run_deploy = exports.fromLiteralsToFromFile = void 0;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        yield run_set_context().catch(core.setFailed);
        yield run_create_secret().catch(core.setFailed);
        yield run_deploy().catch(core.setFailed);
    });
}
exports.run = run;
